...
public final class AcquireInitialTokenResponseImpl implements AcquireInitialTokenResponse {
    ...
    /**
     * Creates a new {@link AcquireInitialTokenResponseImpl} instance with the given token and delay values.
     *
     * @param token The retry token for the response.
     * @param delay The suggested delay for the response.
     */
