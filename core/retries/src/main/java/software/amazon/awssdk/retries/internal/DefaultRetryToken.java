...
public final class DefaultRetryToken implements RetryToken, ToCopyableBuilder<DefaultRetryToken.Builder, DefaultRetryToken> {
     ...
     *
     * @return the latest attempt count.
     */
    public int attempt() {
        return attempt;
    }
     ...
     *
     * @return the latest capacity acquired from the token bucket.
     */
     ...
     *
     * @return the capacity remaining in the token bucket when the last acquire request was done.
     */
     ...
     *
     * @return a new builder to mutate the current instance.
     */
    ...
    public static class Builder implements CopyableBuilder<Builder, DefaultRetryToken> {
         ...
         *
         * @param scope the scope for the retry-token.
         */
         ...
         *
         * @param state the state of the retry-token.
         */
         ...
         *
         * @param capacityAcquired the capacity acquired from the token bucket.
         */
         ...
         *
         * @param capacityRemaining the capacity remaining in the token bucket after the last acquire.
         */
         ...
         *
         * @param failure The throwable to be added.
         * @return
         */
