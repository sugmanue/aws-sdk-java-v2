...
import software.amazon.awssdk.retries.circuitbreaker.AcquireResponse;
import software.amazon.awssdk.retries.circuitbreaker.ReleaseResponse;
import software.amazon.awssdk.retries.circuitbreaker.TokenBucket;
import software.amazon.awssdk.retries.circuitbreaker.TokenBucketStore;
...
public final class StandardRetryStrategyImpl implements StandardRetryStrategy {
    ...
    public RefreshRetryTokenResponse refreshRetryToken(RefreshRetryTokenRequest request) {
        ...
        // 1) is retryable? 2) max attempts reached? 3) can we acquire a token?
    ...
    public RecordSuccessResponse recordSuccess(RecordSuccessRequest request) {
        ...
        return RecordSuccessResponseImpl.create(refreshedToken, releaseResponse);
    }
    ...
    public static class Builder implements StandardRetryStrategy.Builder {
        ...
        public Builder tokenBucketMaxCapacity(int maxCapacity) {
