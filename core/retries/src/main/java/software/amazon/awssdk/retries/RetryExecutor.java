...
import software.amazon.awssdk.retries.executor.DefaultRetryExecutor;
...
public interface RetryExecutor extends Executor {
    ...
    static RetryExecutor createStandard(Consumer<StandardRetryStrategy.Builder> configurer) {
        ...
        return new DefaultRetryExecutor(builder.build(), Sleeper.DEFAULT, "none");
    }
    ...
    static RetryExecutor create(RetryStrategy retryStrategy) {
        return new DefaultRetryExecutor(retryStrategy, Sleeper.DEFAULT, "none");
    }
